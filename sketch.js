...
function preload()
{
  ...
  star_yellow = loadImage("star.png");
  star_gray = loadImage("g_star1.png");
...
createCanvas(canW,canH)
  ...
  button_2.position(450,90);
  button_2.size(50,50);
  button_2.mouseClicked(drop2);
  
  ballon = createImg('balloon.png');
  ballon.position(90,210);
  ballon.size(120,120);
  ballon.mouseClicked(airblow);

  ballon2 = createImg('balloon.png');
  ballon2.position(90,210);
  ballon2.size(120,120);
  ballon2.mouseClicked(airblow);
  

  

  button_3 = createImg('cut_btn.png');
  button_3.position(560,200);
  button_3.size(50,50);
  ...
  star_1.addImage(star_yellow)
  star_1.scale=0.03
  star_2.addImage(star_yellow)
  star_2.scale=0.03
